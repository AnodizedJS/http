...
import { Memory } from '../framework/internal';
export function AnodizedApp(appContext) {
    return __awaiter(this, void 0, void 0, function () {
        var memory, tsFiles, _i, tsFiles_1, file, nonSecureListener;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    nonSecureListener = http.createServer(function (req, res) {
                        res.end('Server Live');
                    });
                    nonSecureListener.listen(appContext.httpPort);
                    console.log(memory.get('endpoints'));
                    console.log(memory.get('controllers'));
                    return [2 /*return*/];
            }
        });
    });
